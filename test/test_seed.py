...
class TestOLTPSeedTables:
    ...
    def test_expected_columns_in_oltp_database(self, oltp_db, col_names_query, table_name, expected):
...
class TestOLTPSeedData:
    ...
    def test_expected_table_length(self, oltp_db, col_names_query, table_name, expected):
...
class TestWarehouseSeed:
    ...
    def test_expected_columns(self, warehouse_db, col_names_query, table_name, expected):
