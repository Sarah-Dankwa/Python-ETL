...
def transform_s3_client(aws_credentials):
    ...
    with mock_aws():
        ...
        client.upload_file(
            "Test_Data/sales_order.parquet",
            "test-transformation-bucket",
            "sales_order/2024/08/20/05:05:05/sales_order.parquet",
        )
        client.upload_file(
            "Test_Data/sales_order.parquet",
            "test-transformation-bucket",
