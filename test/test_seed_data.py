...
dim_design_cols = ["design_id", "design_name", "file_location", "file_name"]
dim_date_cols = [
    "date_id",
    "year",
    "month",
...
currency_cols = ["currency_id", "currency_code", "created_at", "last_updated"]
design_cols = [
    "design_id",
    "created_at",
    "design_name",
...
payment_first_row = [
    1,
    datetime(2022, 11, 3, 14, 20, 52, 187000),
    datetime(2022, 11, 3, 14, 20, 52, 187000),
    2,
    5,
    Decimal("552548.62"),
